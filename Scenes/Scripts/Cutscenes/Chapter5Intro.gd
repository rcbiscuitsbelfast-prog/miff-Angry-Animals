...
## Chapter5Intro - Chapter 5 cutscene player.
...
func initialize_cutscene():
	...
	print("Chapter 5 Intro initialized with %d lines" % lines.size())
...
func start_cutscene():
	...
	show_current_line()
	print("Starting Chapter 5 Intro cutscene")
...
func end_cutscene():
	...
	print("Chapter 5 Intro cutscene complete")
