...
## Chapter3Intro - Chapter 3 cutscene player.
...
func initialize_cutscene():
	...
	print("Chapter 3 Intro initialized with %d lines" % lines.size())
...
func start_cutscene():
	...
	show_current_line()
	print("Starting Chapter 3 Intro cutscene")
...
func end_cutscene():
	...
	print("Chapter 3 Intro cutscene complete")
