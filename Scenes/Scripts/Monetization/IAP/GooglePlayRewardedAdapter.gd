extends Node
class_name GooglePlayRewardedAdapter
...
func load_rewarded_ad() -> void:
	...
	print("GooglePlayRewardedAdapter: Loading rewarded ad %s" % ad_unit_id)
...
func show_rewarded_ad() -> void:
	...
	print("GooglePlayRewardedAdapter: Showing rewarded ad")
